...
%                      );
        ...
        peakPanel = uipanel(tab, 'Position', [0.73,0.75,0.25,0.25]);
        ...
        uicontrol(peakPanel, 'Style', 'slider'...
                           ...
                           , 'Value', 5 ...                           
                           , 'Units', 'Normalized'...
                           , 'Position', [0.025,0.78,0.73,0.091] ... 
                           , 'Callback', {@set_Prominence, label, n} ...                           
                           );
...
%     t = Scale.convert_Units(t, data(n).abr.timeScale, Scale('m')); % convert in ms
    ...
    % Get positive peaks
    [peaks, locs, w, p] = findpeaks(abrSig, fs, 'MinPeakHeight', noiseLevel(1)...
...
function set_Prominence(sliderObj, ~, labelObj, n)
   
    data = guidata(sliderObj);    
    
    % Set prominence value in the data structure 
    data(n).peakDetectionSettings.prominence = sliderObj.Value;
